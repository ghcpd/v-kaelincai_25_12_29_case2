...
These tests were copied from the original project and should pass
consistently with the fixed implementation (deterministic behaviour).
"""
...
class TestCustomerSegmentationDeterminism:
    """
    Tests that demonstrate deterministic behavior in customer segmentation.
    These are the same tests as the original project but should now pass
    reliably because the implementation is deterministic by default.
    """
